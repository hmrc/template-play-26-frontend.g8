...
if [[ -f ./build.sbt ]] && [[ -d ./src/main/g8 ]]; then
    ...
    g8 file://../../../${TEMPLATE} --servicename="New Shiny Service 26" --serviceTargetPort="9999" --package="uk.gov.hmrc.newshinyservice26frontend" -o new-shiny-service-26-frontend "$@"
